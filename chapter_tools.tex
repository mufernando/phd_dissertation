...
\begin{figure}[htp]
\includegraphics[width=0.5\linewidth]{{sweep_figs/boundary_effect_bgs.png}}
\centering
...
To gain a better understanding at which genomic features af


\begin{figure}[htp]
\includegraphics[width=0.5\linewidth]{{sweep_figs/chr1_power.pdf}}
\centering
